package cz.scholz.rhsummit2019amqstreams.tradeaggregator;

public class TradeAggregatorConfig {
    ...
    public TradeAggregatorConfig(String bootstrapServers, String sourceTopic, String targetTopic, String trustStorePassword, String trustStorePath, String keyStorePassword, String keyStorePath, String username, String password) {
    ...
    public static TradeAggregatorConfig fromEnv() {
        ...
        return new TradeAggregatorConfig(bootstrapServers, sourceTopic, targetTopic, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, username, password);
    }
