...
public class PricedPortfolioViewer extends AbstractVerticle {
    private static final Logger log = LoggerFactory.getLogger(PricedPortfolioViewer.class.getName());

    private final Map<String, Float> portfolio = new HashMap<>();

    private final PricedPortfolioViewerConfig verticleConfig;
    private KafkaConsumer<String, Float> consumer;

    public PricedPortfolioViewer(PricedPortfolioViewerConfig verticleConfig) {
