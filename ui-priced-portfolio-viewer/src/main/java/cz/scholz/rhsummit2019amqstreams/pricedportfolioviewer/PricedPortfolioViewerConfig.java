package cz.scholz.rhsummit2019amqstreams.pricedportfolioviewer;

public class PricedPortfolioViewerConfig {
    ...
    public PricedPortfolioViewerConfig(String bootstrapServers, String topic, String groupId, String trustStorePassword, String trustStorePath, String keyStorePassword, String keyStorePath, String username, String password) {
    ...
    public static PricedPortfolioViewerConfig fromEnv() {
        ...
        return new PricedPortfolioViewerConfig(bootstrapServers, topic, groupId, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, username, password);
    }
